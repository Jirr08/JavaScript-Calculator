...
result.addEventListener("click", function() {
    ...
    //forming an array of operators. for above string ir will be: operators = ["+", "+", "-", "*", "/"]
    ...
    //now we are looking through the array and doing one operation at a time.
    ...
    input.innerHTML = numbers[0]; //displayed the output

    resultDisplayed = true; //turning flag if result is displayed
});

//crearing the input on press of clear
